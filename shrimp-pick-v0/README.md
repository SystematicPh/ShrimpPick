...
Aquatic Shop is a Next.js App Router ecommerce app for ornamental aquarium fish, plants, and aquatic supplies with Supabase Auth, Database, Storage, and Realtime chat.
